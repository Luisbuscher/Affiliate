...
export default function Navbar() {
    return (
        <ul className="navbar-nav nav flex-grow-1 pe-3 pt-4 ps-3">
            ...
            <a href="/user/affiliates" style={{ color: 'white', textDecoration: 'none' }}> <li className="nav-item mt-4">  <i className="bi-people-fill"></i> Meus Afiliados</li></a>
            <a href="/user/traffic" style={{ color: 'white', textDecoration: 'none' }}> <li className="nav-item mt-4">   <i className="bi-wifi"></i> Tráfego</li></a>
            ...
            <a href="/user/payments" style={{ color: 'white', textDecoration: 'none' }}>  <li className="nav-item mt-4">   <i className="bi-receipt"></i> Pagamentos</li></a>
            <a href="/user/withdraw" style={{ color: 'white', textDecoration: 'none' }}> <li className="nav-item mt-4">    <i className="bi-wallet"></i> Solicitar Saque</li></a>
